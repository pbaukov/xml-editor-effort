    ...
    var r = e("../lib/event"),
        ...
        a = function (e, t) {
            ...
            var L = !1,
                A = function (e) {
                    k && (e = k(e), k = null),
                        c ? (b(), e && t.onPaste(e), c = !1) : e == a[0] ? L && t.execCommand("del", {
                                source: "ace"
        ...
        r.implement(this, i),
            ...
            this.onChange = function (e) {
                ...
                var r = this.row,
                    ...
                    s = n.start,
                    o = n.end;
                t.action === "insertText" ? s.row === r && s.column <= i ? s.row === o.row ? i += o.column - s.column : (i -= s.column, r += o.row - s.row) : s.row !== o.row && s.row < r && (r += o.row - s.row) : t.action === "insertLines" ? s.row <= r && (r += o.row - s.row) : t.action === "removeText" ? s.row === r && s.column < i ? o.column >= i ? i = s.column : i = Math.max(0, i - (o.column - s.column)) : s.row !== o.row && s.row < r ? (o.row === r && (i = Math.max(0, i - o.column) + s.column), r -= o.row - s.row) : o.row === r && (r -= o.row - s.row, i = Math.max(0, i - o.column) + s.column) : t.action == "removeLines" && s.row <= r && (o.row <= r ? r -= o.row - s.row : (r = s.row, i = 0)),
        ...
        this.comparePoints = i,
            ...
            this.$onChange = function (e) {
                ...
                for (var f = 0, l = a.length; f < l; f++) {
                    ...
                    c.end.row == i && c.end.column >= n.column && (c.end.column == n.column && u > 0 && f < l - 1 && c.end.column > c.start.column && c.end.column == a[f + 1].start.column && (c.end.column -= u), c.end.column += u, c.end.row += o)
                }
                if (o != 0 && f < l)
                    for (; f < l; f++) {
                        var c = a[f];
        ...
        this.CHANGE_CURSOR = 1,
            ...
            this.onResize = function (e, t, n, r) {
                ...
                if (r && (e || o.height != r)) {
                    ...
                    this.session && (this.session.setScrollTop(this.getScrollTop()), s |= this.CHANGE_FULL)
                }
            ...
            this.setTheme = function (e) {
                function r(n) {
                    ...
                    if (!n.cssClass)
                        return;
                    i.importCssString(n.cssText, n.cssClass, t.container.ownerDocument),
    ...
    (function () {
        i.implement(this, o),
            ...
            this.update = function (e) {
                ...
                v += m.left + m.right,
                v !== this.gutterWidth && (this.gutterWidth = v, this.element.style.width = Math.ceil(this.gutterWidth) + "px", this._emit("changeGutterWidth", v))
            },
